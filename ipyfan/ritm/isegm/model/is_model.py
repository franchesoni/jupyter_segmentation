...
from ipyfan.ritm.isegm.model.modifiers import LRMult
from ipyfan.ritm.isegm.model.ops import (
    BatchImageNormalize,
    DistMaps,
    ScaleLayer,
)
...
class ISModel(nn.Module):
    def __init__(
        ...
        maps_transform_out_channels=64,  # added
        norm_mean_std=([0.485, 0.456, 0.406], [0.229, 0.224, 0.225]),
    ):
        super().__init__()
        self.maps_transform_out_channels = maps_transform_out_channels  # added
        ...
        if use_rgb_conv:
            ...
            self.maps_transform = nn.Conv2d(
                ...
                out_channels=maps_transform_out_channels,
                kernel_size=3,
                stride=2,
                padding=1,
            )
