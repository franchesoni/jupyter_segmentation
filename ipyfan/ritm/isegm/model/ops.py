...
import ipyfan.ritm.isegm.model.initializer as initializer
from ipyfan.ritm.isegm.utils.cython import get_dist_maps as get_dist_maps_cpu
...
class DistMaps(nn.Module):
    def __init__(
        ...
        if self.cpu_mode:
            self._get_dist_maps = get_dist_maps_cpu
